import 'package:abshr/modules/business_stats/models/business_question.dart';
...
/// Business stats view - displays commercial statistics questions
class BusinessStatsView extends StatelessWidget {
  const BusinessStatsView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(BusinessStatsController());
    final args = Get.arguments;
    final role = args is Map<String, dynamic> ? args['role'] as String? : 'business';
    final primaryColor = ThemeHelper.getPrimaryColor(role);

    return Scaffold(
      appBar: AppBar(
        title: Text('business_stats_title'.tr),
      ),
      body: Obx(() {
  ...
  Widget _buildQuestion(
    ...
    BusinessStatsController controller,
